...
const exercises = [
  // Pecho
  {
    ...
    description: 'Ejercicio compuesto clásico para el desarrollo del pectoral.',
    category: 'Pecho',
  },
  {
  ...
  // Espalda
  {
    ...
    equipment: 'Barra',
    difficulty: 'Avanzado',
    description: 'Ejercicio fundamental para la espalda.',
    category: 'Espalda',
  },
  {
    name: 'Remo con Barra',
    ...
    equipment: 'Barra',
    difficulty: 'Intermedio',
    description: 'Construye densidad y fuerza en la espalda.',
    category: 'Espalda',
  },
  {
    name: 'Jalón al Pecho',
  ...
  },
  {
    ...
    equipment: 'Máquina',
    difficulty: 'Principiante',
    description: 'Ejercicio compuesto seguro para cargar peso.',
    category: 'Piernas',
  },
  {
  ...
  // Hombros
  {
    ...
    equipment: 'Barra',
    difficulty: 'Intermedio',
    description: 'Ejercicio compuesto para hombros fuertes.',
    category: 'Hombros',
  },
  {
  ...
  // Brazos
  {
    ...
    equipment: 'Barra',
    difficulty: 'Principiante',
    description: 'Clásico para bíceps.',
    category: 'Brazos',
  },
  {
